...
//$results = "SELECT student_id, first_name, last_name, month1, month2, month3, month4, month5, month6, month7, month8, month9, total_tuition, downpayment, balance, monthly_payment, late_payer, fully_paid, tag, user_id FROM birthright_db.accounts, birthright_db.login where user_id = student_id and verified='1' and month6 != '0' and tag = '2'";
$results = "SELECT * FROM birthright_db.masterlist, birthright_db.login, birthright_db.accounts where verified='1' and tag = '2' and month6 != '0' and Status='Enrolled' and user_id=student_id and user_id=Student_No and student_id=Student_No";
