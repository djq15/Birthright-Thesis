...
<?php 
	...
	$num1 = mysqli_query($db, "SELECT * FROM birthright_db.announcement WHERE number='3'");	 
...
<?php 
	if ($_SESSION['tag'] == '2') {
	//echo 'href="./dash.php">';  
	echo '<a href="dash.php"> Back to dashboard</a>';
	}
	else {
	echo '<a href="dash2.php"> Back to dashboard</a>'; 	
	}
?>
<br>
<br>
