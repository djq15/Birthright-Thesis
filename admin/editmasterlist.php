...
<p align="center">Delete User from masterlist database (students only)</p>
...
if (isset($_POST['save'])) {
	...
	*/
	...
	$results = mysqli_query($db, "SELECT * from birthright_db.masterlist");
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a class = "edit_btn" href="javascript:deleteme('<?php echo $row['Student_No']; ?>')" name="delete">Delete</a> <!-- hit -->
			</td>
...
{
	if (confirm('Do you want to delete student no "'+delid+'" ?')){
			window.location.href='deletemasterlist.php?del_id=' +delid+'';
			return true;
	}
}
</script>
