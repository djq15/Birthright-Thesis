...
<p align="center">Announcements 1</p>
...
<?php
	...
	//mysqli_query($db, "UPDATE birthright_db.announcement SET tagname='$tagname' WHERE number = '$studentno'"); //hit
	//$insert = $mysqli->query("UPDATE birthright_db.announcement SET tagname='".mysql_real_escape_string($_POST['tagname'])."' WHERE number = '$studentno'");
