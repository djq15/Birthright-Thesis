<?php
	session_start(); if ( $_SERVER['REQUEST_METHOD']=='GET' && realpath(__FILE__) == realpath( $_SERVER['SCRIPT_FILENAME'] ) && $_SESSION['tag'] !="4") {
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<!-- <a class = "edit_btn" href="dexupload1.php?editz=<?php echo $row['username']; ?>">Upload File</a> -->
				<a class = "edit_btn" href="dexupload11.php?editz=<?php echo $row['username']; ?>">Upload</a>
			</td>
			<td>
				<!-- <a class = "edit_btn" href="studentfolder.php?editz=<?php echo $row['username']; ?>">Student File</a> -->
				<a class = "edit_btn" href="studentfolder2.php?editz=<?php echo $row['username']; ?>">Student&nbsp;File</a>
			</td>
			<td>
