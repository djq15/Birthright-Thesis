...
<input type = "hidden" name = "studentid" value = "<?php echo $studentid; ?>">
	...
	<div class = "input-group">
		...
		<input type = "number" name = "total_payment" value = "<?php echo $total_payment; ?>" readonly disabled>
	</div>	
	<div class = "input-group">
	...
	<div class = "input-group">
		...
		<select style="width:430px;" name="late_payer">
				<option value="<?php echo $latepayer; ?>"><?php echo $latepayer; ?></option>
				<?php 
				if ($latepayer == "Y"){?>
