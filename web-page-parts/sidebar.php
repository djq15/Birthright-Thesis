...
?>	
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
		  ...
		  <?php if ($_SESSION['tag'] == '2') {
			//echo 'href="./dash.php">';  
			echo '<a class="sidebar-brand d-flex align-items-center justify-content-center" href="./dash.php">';
			}
			else {
			echo '<a class="sidebar-brand d-flex align-items-center justify-content-center" href="./dash2.php">';	
			}
			?>
		  ...
		  <li class="nav-item active">
			...
			<?php if ($_SESSION['tag'] == '2') {
			//echo 'href="./dash.php">';  
			echo '<a class="nav-link" href="./dash.php">';
			}
			else {
			echo '<a class="nav-link" href="./dash2.php">'; 	
			}
			?>
