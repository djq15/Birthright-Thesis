...
$results = "SELECT Student_No, Status, Last_name, First_name, Middle_initial, Nickname, tag, user_id, Gender, Street, Province, Contact_No, Date_of_birth, Fathers_name, Mothers_name FROM birthright_db.masterlist, birthright_db.login where user_id=Student_No and verified='1' and Status='Enrolled' and tag='2'";
...
.table.sticky th {
	...
	<table class="table sticky">
		<tr style="white-space:nowrap;">
			<th style="background-color: #888888;color:white;">Student No</th>
			<th style="background-color: #888888;color:white;">Status</th>
			<th style="background-color: #888888;color:white;">Last name</th>
			<th style="background-color: #888888;color:white;">First name</th>	
			<th style="background-color: #888888;color:white;width: 5%;">Middle Initial</th>	
			<th style="background-color: #888888;color:white;">Nickname</th>	
			<th style="background-color: #888888;color:white;width: 5%;">Gender</th>	
			<th style="background-color: #888888;color:white;width: 9%;">Contact No</th>	
			<th style="background-color: #888888;color:white;">Date of Birth</th>	
			<th style="background-color: #888888;color:white;width: 10%;">Street</th>	
			<th style="background-color: #888888;color:white;width: 10%;">Province</th>	
			<th style="background-color: #888888;color:white;width: 10%;">Father\'s name</th>	
			<th style="background-color: #888888;color:white;width: 10%;">Mother\'s name</th>	
		</tr>
	';
	$content .= fetch_data();
	$content .= '</table>';
